...
const PUFManu string = "PUF Manufacturer"
...
func NewClient(prsn Personality, nv note.Verifier) TClient {
	return TClient{
		person:      prsn,
...
func (c TClient) VerIncl(entry []byte, pf *trillian.Proof) bool {
...
func (c *TClient) UpdateChkpt(chkptNewRaw personality.SignedCheckpoint, pf *trillian.Proof) error {
